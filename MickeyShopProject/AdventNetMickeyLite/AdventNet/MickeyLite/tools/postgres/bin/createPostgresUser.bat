...
set JAVA_OPTS= -Dserver.home="%SERVER_HOME%" -Dapp.home="%SERVER_HOME%"  -Ddb.home="%DB_HOME%" -Dfile.encoding="utf8" -Djava.library.path="%SERVER_HOME%\lib\native" -Dstandalone.logger.name="createpostgresuser" -Drun.standalone.class="com.zoho.mickey.tools.postgres.CreatePostgresDBUser" -Dorg.bouncycastle.fips.approved_only="true" -Djava.security.properties="../conf/fips.security"
