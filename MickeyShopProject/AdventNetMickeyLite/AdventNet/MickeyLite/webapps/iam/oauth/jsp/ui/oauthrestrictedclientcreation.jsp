...
function addAPIClient(f){
	...
	var service_name = '<%=IAMEncoder.encodeJavaScript(serviceName)%>';
	if(client_type == 'JS'){
	...
	var params = "client_name=" + euc(client_name) + "&client_type=" + euc(client_type) + "&client_redirect_uri=" + euc(client_redirect_uri) + "&restricted_type=" + euc(restrictedType) + "&client_domain=" + euc(client_domain) +"&servicename="+ euc(service_name)+ "&" + getcsrfParams(); //No I18N
	if(client_type === "JS") {
