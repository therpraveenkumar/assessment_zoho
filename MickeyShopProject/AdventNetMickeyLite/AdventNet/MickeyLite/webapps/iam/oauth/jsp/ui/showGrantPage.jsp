...
<%if(isDirectAccess) {%>
		...
		<div class="screen"></div>
            ...
            <div class="wrap">
	  		...
	  		<% if(!isClientPortal) { %>		
	  				<img class="logo" src="<%=StaticContentLoader.getStaticFilePath("/v2/components/images/newZoho_logo.svg")%>">
      		<% } %>  	       
      <% 
      				if(isDirectAccess) 
      				{
