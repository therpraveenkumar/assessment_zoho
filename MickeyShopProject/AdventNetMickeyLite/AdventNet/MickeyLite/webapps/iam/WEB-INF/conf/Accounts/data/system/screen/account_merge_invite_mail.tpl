	        	...
	        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	            	<tr border="0">
	                		...
	                		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		                        ...
		                        <b><a href="#" rel="nofollow" style="text-decoration:none !important;cursor: default !important;color: #222 !important;"><@i18n key="IAM.NEW.HI.USERNAME" arg0="${ztpl.FIRST_NAME}"/></a></b>
                   				...
                   				<tr>
				                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
				                        <@i18n key="IAM.MAIL.ORG.MERGE.INVITE.SUBHEADER" arg0="${ztpl.ADMIN_FULL_NAME}" arg1="${ztpl.ACCOUNT_NAME}" arg2="${ztpl.INVITED_ACCOOUNT_NAME}"/><br/>
				                    </td>
			                    </tr>
                    			<tr>
                    			...
                    			<tr>
				                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
				                        <@i18n key="IAM.MAIL.ORG.MERGE.INVITE.NOTE" arg0="${ztpl.ACCOUNT_NAME}" arg1="${ztpl.ACCOUNT_NAME}" arg2="${ztpl.ADMIN_EMAIL_ID}"/>
				                    </td>
                    			</tr>
                    			<tr>
				                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
