	        	...
	        	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	            	<tr border="0">
	                		...
	                		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		                        ...
		                        <b><a href="#" rel="nofollow" style="text-decoration:none !important;cursor: default !important;color: #222 !important;"><@i18n key="IAM.NEW.HI.USERNAME" arg0="${ztpl.FIRST_NAME}"/></a></b>
                   				...
                   				<tr>
				                    <td style="font-size: 24px;line-height: 48px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
					                    ...
					                    <#if ztpl.PASSWORD_EXPIRY_REMAINING_DAYS !=0 >
						                    <@i18n key="IAM.NEW.TPL.PASSWORD.EXPIRY.MESSAGE.HEADER" arg0="${ztpl.PASSWORD_EXPIRY_REMAINING_DAYS}"/>
					                    <#else>
											<@i18n key="IAM.NEW.TPL.PASSWORD.EXPIRY.MESSAGE.TODAY.HEADER"/>				                    	
					                    </#if>
					                 	</b>
				                    </td>
                   				</tr>
                   				<tr>
				                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
				                        <@i18n key="IAM.NEW.TPL.PASSWORD.EXPIRY.MESSAGE.CONTENT"  arg0="${ztpl.ACCOUNT_NAME}" arg1="${ztpl.PASSWORD_POLICY_DAYS}"/><br/>
				                    </td>
			                    </tr>
                    			<tr>
                    			...
                    			<tr>
				                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
				                        <@i18n key="IAM.NEW.MAIL.TPL.CONTACT.SUPPORTT" arg0="${ztpl.SUPPORT_EMAIL_ID}"/>
				                    </td>
                    			</tr>
                   				<tr>
				                    <td style="padding:20px 0 0 0;font-size: 14px;line-height: 24px;font-family: 'Open Sans','Trebuchet MS',sans-serif;">
