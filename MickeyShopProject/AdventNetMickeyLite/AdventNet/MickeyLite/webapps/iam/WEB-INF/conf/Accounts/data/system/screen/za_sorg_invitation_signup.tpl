...
<#include "za_sorg_invitation_static">
</head>
<body class="bodybg">
<#if !tos_link??>
 ...
 <#assign privacy_link><@i18n key="IAM.LINK.PRIVACY" /></#assign>
	...
	<#else>
		...
		<section class="containerbox">
			<form name="accountinvitationform" class="form" action="${za.contextpath}/sorginvite.ac" method="post">
						...
						<#if isvalidrequest && isSorgInvite>
